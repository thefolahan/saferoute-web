      ...
      <div className="flex flex-col gap-5 py-5">
        <div className="flex flex-wrap items-center gap-5">
          ...
          <div className="flex w-[348px] flex-col justify-center gap-1">
            ...
            <span className="inline-flex w-fit items-center justify-center rounded-[5px] bg-[#F2F4F7] px-[11px] py-[7px] text-sm font-medium leading-[18px] capitalize text-gray-700">
        ...
        <div className="flex w-full max-w-[610px] flex-col gap-5 py-[17px]">
          ...
          <div className="flex flex-col gap-5">
            ...
            <FormRow label="Department" value={profile.department} />
          </div>
        </div>
      </div>
    </>
        ...
        <div className="flex w-full max-w-[610px] flex-col gap-5 py-[17px]">
          ...
          <div className="flex flex-col gap-5">
            ...
            <StatusRow
              ...
              tone={profile.mfaEnabled ? 'success' : 'plain'}
            />
            <StatusRow label="SMS Backup" value="—" tone="plain" />
          </div>
        </div>
      </div>
    </>
