...
import { DASHBOARD_ACTIONS } from './_lib/needs-action';

/* Figma 907:12642 "Dashboard". */

const KPIS = [
  { label: 'Total users', value: '12,930' },
  { label: 'Active users', value: '10,000' },
  { label: 'Online users', value: '345' },
  { label: 'Live incident count', value: '3,456' },
  { label: 'SOS requests', value: '40' },
  { label: 'Crime reports', value: '234' },
  { label: 'Traffic reports', value: '209' },
  { label: 'Road closure reports', value: '436', down: true },
  { label: 'Emergency alerts', value: '50' },
  { label: 'Reports awaiting review', value: '3' }
];

/* Bars are drawn as a 132px track (Primary/Gray/100) with the Success/600 fill
   pinned to the bottom — the Figma frame sets the empty space as top padding. */
const USER_GROWTH = [
  { month: 'Jan', pad: 43 },
  { month: 'Feb', pad: 22 },
  { month: 'Mar', pad: 22 },
    ...
    <Shell title="Dashboard" filters>
      ...
      <section className="flex flex-col gap-8 px-8 py-5">
        <Card>
          ...
          <ActionRowList rows={DASHBOARD_ACTIONS} />
        </Card>
