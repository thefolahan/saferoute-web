  ...
  return (
    <main className="relative min-h-screen w-full overflow-hidden bg-[#FAFAFA]">
      ...
      <div className="relative mx-auto flex min-h-screen w-full flex-col">
        {/* Same navbar as the /enterprise page: back-left + logo-centre on
            mobile, logo-left + back-right on desktop. */}
        <header className="relative z-10 flex h-[73px] items-center px-6 sm:h-[88px] sm:px-12">
          ...
          <Link href="/" className="mx-auto flex items-center gap-1 sm:mx-0">
            <Image
          ...
          <Link
            href="/"
            className="ml-auto hidden text-[14px] font-medium leading-4 text-gray-500 transition-opacity hover:opacity-70 sm:block"
          >
            Back to SafeRoute
          </Link>
        </header>
