    ...
    <main id="top">
      <section className="relative bg-white">
        ...
        <div className="flex flex-col items-center gap-10 px-6 pb-24 pt-[200px] text-center sm:px-10 sm:pt-[280px]">
          <Reveal
            as="h1"
            className="text-[40px] font-bold leading-[1.1] tracking-[-0.02em] text-[#0A0D12] sm:text-[58px] sm:leading-[68px]"
          >
            Need some help?
          </Reveal>
          <Reveal delay={130} className="flex w-full justify-center">
