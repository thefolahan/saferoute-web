export const copyrightPolicyText = `Last Updated: July 3, 2026

COPYRIGHT POLICY
SafeRoute respects the intellectual property rights of others and expects our users to do the same. We will respond to valid notices of copyright infringement in accordance with the Nigerian Copyright Act, 2022 and other applicable Nigerian law.

COPYRIGHT CONTACT IN NIGERIA
SafeRoute is designed for users in Nigeria and maintains a copyright contact to receive notifications of claimed copyright infringement.
...
If you believe that content on SafeRoute infringes your copyright, you may submit a copyright takedown notice to our designated copyright contact.

REQUIREMENTS FOR A VALID COPYRIGHT NOTICE

To help us review your notice, it must include all of the following information:
...
3. Identification of the Infringing Material
   ...
   - The specific URL(s) where the allegedly infringing content is located on SafeRoute
...
5. Statement of Accuracy
   ...
   - You must include the following statement: "The information in this notification is accurate, and under penalty of law, I am the owner, or an agent authorized to act on behalf of the owner, of an exclusive right that is allegedly infringed."
...
1. We will review your notice to confirm it includes the information needed to assess the claim

2. If valid, we will remove or disable access to the allegedly infringing content

3. We will notify the user who posted the content that it has been removed

4. The user may submit a counter-notification if they believe the content was removed in error

Processing Time: Valid takedown notices are typically processed within 24 to 48 hours of receipt.
...
3. Statement Under Penalty of Law
...
4. Consent to Jurisdiction
   ...
   - You must include the following statement: "I consent to the jurisdiction of the Federal High Court of Nigeria and any other Nigerian court or authority with competent jurisdiction, and I will accept lawful service of process from the person who provided the original copyright notification or an agent of such person."
...
1. We will forward your complete counter-notification to the party who filed the original copyright notice

2. That party will have 10 to 14 business days to notify us that they have filed a court action or obtained a lawful order to restrain you from engaging in infringing activity

3. If we do not receive such notification within that timeframe, we may restore the content

Important: By submitting a counter-notification, you are consenting to the jurisdiction of Nigerian courts and agreeing that the copyright claimant may file a lawsuit or seek lawful remedies against you.

REPEAT INFRINGER POLICY
SafeRoute has adopted and reasonably implemented a policy to terminate, in appropriate circumstances, the accounts of users who repeatedly infringe the copyrights of others.
...
- User permanently ineligible for monetization and creator programs
...
COURT RULINGS
If a court or competent Nigerian authority determines that a user is a copyright infringer or repeat infringer, we will take action on that user's account in accordance with the ruling or lawful direction.
...
- TV shows, movies, or music videos unless you own them or have permission
...
- Content downloaded from other platforms such as YouTube, TikTok, Instagram, or X without the required rights

YOU MAY UPLOAD:

- Content you personally filmed or created

- Content for which you have explicit written permission through a signed Media Release Form or other valid written approval

- Original commentary, narration, and creative work

- Publicly available content that is confirmed to be in the public domain or otherwise lawful to use in Nigeria
...
- Legal liability under applicable Nigerian copyright and civil law

- Potential damages, costs, and legal fees

- Termination of your SafeRoute account

Please ensure your claim is accurate before submitting.

ADDITIONAL INFORMATION

FAIR DEALING AND OTHER LIMITATIONS

Nigerian copyright law includes certain exceptions and limitations, including fair dealing in appropriate circumstances. These issues are determined case by case and may apply to commentary, criticism, news reporting, teaching, scholarship, or research. Fair dealing is not a blanket permission to use copyrighted content.

If you believe your use qualifies as fair dealing or another lawful exception, you may include that information in a counter-notification if your content is removed.
